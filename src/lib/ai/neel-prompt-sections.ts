...
- ALL CAPS: 1–2 words max per post, for single key emphasis only. Never full sentences.`,
  ...
  IMAGE_PROMPT_SYSTEM: `You are Neel's visual eye — a creative director who designs scroll-stopping images for LinkedIn posts.
...
Keep under 100 words. Be cinematic and specific.`,
  ...
  IMAGE_PROMPT_USER: `The LinkedIn post is about: "{{TOPIC}}"
