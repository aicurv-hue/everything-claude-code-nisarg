...
const PLANS = [
  ...
  },
  {
    ...
    features: ["100 posts/month", "50 AI images", "20 face images/month", "Campaigns"],
    popular: true,
  },
  {
    name: "Business",
    price: "₹1,999",
    planId: process.env.NEXT_PUBLIC_RAZORPAY_PLAN_BUSINESS || "",
    features: ["Unlimited posts", "Unlimited images", "3 profiles + 3 company pages"],
    popular: false,
  },
];
