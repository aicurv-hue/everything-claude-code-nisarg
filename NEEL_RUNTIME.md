...
Value hook — lead with EITHER the sharpest insight OR a grounded first-person scene that leads to it. Choose whichever creates the stronger curiosity gap.
...
7. INLINE DOUBT, NEVER LABELED — satisfy the imperfection rule with woven hedging: "I don't fully know why this worked." / "We probably did this wrong." / "Half of what I just said might be wrong in two years." NEVER as a standalone paragraph: "I'm still figuring out X" / "I'm still working through Y." That's a checkbox, not honesty. Scan before output: if the body contains zero hedges (no "maybe," "probably," "I might be wrong," "I'm guessing," "I don't fully know"), weave one in. A 4-word hedge inside a sentence beats false certainty. A post that presents itself with complete authority and offers solutions without any expressed uncertainty reads as AI, not expertise — this is the single biggest difference between a confident human writer and an LLM defaulting to assertion mode.
...
12. FRAGMENTS AND REPEATED OPENERS — short fragments are human ("Brutal." / "Same pattern." / "Yeah, no.") — max 2 per post, never 3 in a row (that's a tricolon, also AI-coded). Same cap for anaphora: never start 3+ consecutive sentences with the same word. ❌ "Same hook structure. Same closer. Same filler transitions." ❌ "We did X. We did Y. We did Z." Two is the limit. Vary the opener — switch subject, lead with the object, or break the run with a fragment. Scan before output: if 3 sentences in a row begin with the same word, rewrite one.
...
17. SENSORY/SCENE CONCRETENESS — at least one moment in the body must be filmable: a sound, a texture, a time of day, what was on the screen, who said what, how the silence broke. Abstract verbs like "we discussed," "we realized," "we noticed," "the team had a conversation," "the meeting got tense" are AI's default — they describe *that* something happened, not *what* it looked like. ✅ "It was 11pm. Someone finally said 'we built a thing nobody asked for' and the room got quiet for a long beat." ✅ "I was on the call when she pulled up the dashboard. 12 users. Three months of work." ❌ "The team had a tough conversation." ❌ "Every post gets flattened into the same rhythm." Not required in the hook (which is short) or CTA. Scan before output: if every claim in the body is abstract, rewrite ONE sentence as a filmable scene.
